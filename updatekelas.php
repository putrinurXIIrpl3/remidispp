...
if (isset($_POST["ok"])) {
    ...
    $input = mysqli_query($koneksi, "UPDATE kelas SET nama_kelas='$nama_kelas', kompetensi_keahlian='$kompetensi_keahlian' WHERE id_kelas='$id_kelas'");
                ...
                <div class="container px-0">
                    <nav class="navbar navbar-light navbar-expand-xl">
                        <a href="index.html" class="navbar-brand">
                            <h1 class="text-primary display-4">UPDATE KELAS</h1>
                        </a>
...
?>
                 ...
                 <div class="row g-5 align-items-center">
                    <div class="col-lg-10">
                        <div class="appointment-form p-3">
                            <h1 class="display-4 mb-4 text-white">UPDATE KELAS</h1>
            ...
            <div class="form-group" >
                ...
                <input type = "text" name="id_kelas" class="form-control" value="<?php echo $row['id_kelas']; ?>" readonly>
            </div>

             <div class="form-group" >
                            <label style="color:black;"> Nama Kelas </label>
                            <input type = "text" name="nama_kelas" class="form-control" value="<?php echo $row['nama_kelas']; ?>" >
                        </div>
                        <div class="form-group" >
                            <label style="color:black;"> Kompetensi Keahlian </label>
...
<center><button type="submit" name="ok">Submit</button></center>
           <BR>
           <center><a href="tabelkelas.php" target="_blank"><button type="button">Lihat Kelas Lainnya</button></a></center>
       <?php } ?>
                                </div>
                            </form>
                        </div>
