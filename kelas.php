                 ...
                 <div class="row g-5 align-items-center">
                    <div class="col-lg-10">
                        <div class="appointment-form p-3">
                            <h1 class="display-4 mb-4 text-white">KELAS</h1>
                            <form method="post" action="">
                                <div class="row gy-3 gx-4">
                                   
                                     <div class="col-lg-30">
                                        <input type="text" class="form-control py-3 border-white bg-transparent text-white" placeholder="Id Kelas" name="id_kelas">
                                    </div>
                                    <div class="col-lg-30">
                                        <input type="text" class="form-control py-3 border-white bg-transparent text-white" placeholder="Nama Kelas"name="nama_kelas">
                                    </div>
                                    <div class="col-lg-30">
                                        <input type="text" class="form-control py-3 border-white bg-transparent text-white" placeholder="Kompetensi Keahlian"name="kompetensi_keahlian">
                                    </div>
                                    <div class="col-lg-6">
                                        <button type="submit" class="btn btn-primary btn-primary-outline-0 w-100 py-3 px-5" name="ok" >SUBMIT</button>
                                    </div>
                                     <div class="col-lg-6">
                                        <a href="tabelkelas.php"> <button type="button" class="btn btn-primary btn-primary-outline-0 w-100 py-3 px-5">LIHAT KELAS</button></a>
                                    </div>
                                </div>
                            </form>
                        </div>
